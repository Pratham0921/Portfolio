      ...
      <div className="content-width">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-bold text-white mb-4 section-header">
            My UE Learning Journey
          </h2>
          <p className="text-text-secondary text-lg">
            Evolution from Blueprint beginner to C++ systems programmer
          </p>
        </motion.div>
              ...
              return (
                ...
                >
                  ...
                  <div className="absolute left-4 md:left-8 top-2">
                    <motion.div
                      ...
                      className={`w-4 h-4 rounded-full border-4 border-background ${
                        isCurrent
                          ? 'bg-gradient-to-r from-accent to-accent-light shadow-glow-accent'
                          : 'bg-surface'
                      }`}
                    >
                      {isCurrent && (
                  ...
                  <div className="glass-card p-6">
                    {/* Date */}
                    <time className="text-accent font-mono text-sm mb-2 block">
                      {entry.date}
                    </time>
                      ...
                      <div className="flex flex-wrap gap-3 pt-4 border-t border-surface">
                        {entry.attachments.map((att, i) => (
                          <a
                            ...
                            className="inline-flex items-center gap-2 text-xs text-accent hover:text-accent-light font-mono transition-colors"
                          >
                            <span>📎</span>
                            <span>{att.label}</span>
                          </a>
